...
async function main() {
  ...
  const products: ProductSeed[] = [
    ...
    // ===== PS PLUS SUBSCRIPTIONS (INDIA) =====
    {
      ...
      region: Region.INDIA,
      price: 1350,
      imageUrl: '/images/cards/ps-plus-essential-3m.svg',
      sortOrder: 1,
    ...
    },
    {
      ...
      region: Region.INDIA,
      price: 2250,
      imageUrl: '/images/cards/ps-plus-extra-3m.svg',
      sortOrder: 2,
      categories: ['ps-plus', 'multiplayer'],
    },
    // ===== TOP-UP CARDS =====
    {
      ...
      region: Region.TURKEY,
      price: 50,
      imageUrl: '/images/cards/psn-try-50.svg',
      sortOrder: 1,
    ...
    },
    {
      ...
      region: Region.TURKEY,
      price: 100,
      imageUrl: '/images/cards/psn-try-100.svg',
      sortOrder: 2,
      categories: ['donations'],
    },
    {
      ...
      region: Region.TURKEY,
      price: 200,
      imageUrl: '/images/cards/psn-try-200.svg',
      sortOrder: 3,
      categories: ['donations'],
    },
    {
      ...
      region: Region.TURKEY,
      price: 500,
      imageUrl: '/images/cards/psn-try-500.svg',
      sortOrder: 4,
      categories: ['donations'],
    },
    {
      ...
      region: Region.TURKEY,
      price: 1000,
      imageUrl: '/images/cards/psn-try-1000.svg',
      sortOrder: 5,
      categories: ['donations'],
    },
    {
      ...
      region: Region.INDIA,
      price: 500,
      imageUrl: '/images/cards/psn-inr-500.svg',
      sortOrder: 6,
      categories: ['donations'],
    },
    {
      ...
      region: Region.INDIA,
      price: 1000,
      imageUrl: '/images/cards/psn-inr-1000.svg',
      sortOrder: 7,
      categories: ['donations'],
    },
    {
      ...
      region: Region.INDIA,
      price: 2000,
      imageUrl: '/images/cards/psn-inr-2000.svg',
      sortOrder: 8,
      categories: ['donations'],
    },
  ];
  ...
  const banners = [
    {
      ...
      imageUrl: '/images/banners/turkey-deals.svg',
    ...
    },
    {
      ...
      imageUrl: '/images/banners/ps-plus.svg',
    ...
    },
    {
      ...
      imageUrl: '/images/banners/topup-psn.svg',
