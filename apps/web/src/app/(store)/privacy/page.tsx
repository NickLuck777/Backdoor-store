...
export const metadata: Metadata = {
  ...
  description: 'Политика конфиденциальности Reloc Store — порядок обработки и защиты персональных данных пользователей.',
};
...
Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сервиса Reloc Store (далее — «Сервис»), расположенного по адресу reloc.store.
...
Для реализации любого из перечисленных прав напишите на **support@reloc.ru** с указанием вашего запроса.
...
По всем вопросам обработки персональных данных обращайтесь: **support@reloc.ru**
`;
      ...
      <section className="max-w-3xl mx-auto px-4 pb-20">
        ...
        <div className="mt-8 bg-[#1E1E38] border border-[#3A3A5C] rounded-2xl p-6 text-center">
          <p className="text-[#B0B0B0] text-sm">
            ...
            <a href="mailto:support@reloc.ru" className="text-[#6699FF] hover:text-white transition-colors">
              Напишите нам
            </a>
          </p>
        </div>
